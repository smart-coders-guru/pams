                    ...
                    @foreach(Session::get('apps') as $appS)
                        @if($appS->apps_login=='noApps')
                            <ul class="dropdown-menu">
                                ...
                                @foreach($app as $pp)
                                    <li><a href="{{ url('/'.$pp->apps_name) }}"><i class="fa fa-university"></i>{{$pp->apps_name}}</a></li>
                                @endforeach
                            </ul>
                        @endif
                    @endforeach
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                 ...
                 <section class="cont-header">
                    <div class="row">
                        <div class="col-md-4"> <h2>Report list</h2></div>
                        <div class="col-md-8"> 
                          <ul class="breadcrumb">
                                    ...
                                    @foreach($reports as $reports)  
                                       @if($reports->report_state==0)
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="width:30px;"> {{ $reports->report_id }}</td>
                                                <td> {{ $reports->report_title }}</td>
                                                <td> <a href="{{ $reports->report_link }}"> {{ $reports->report_link }}</a></td> 
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                          ...
                                                          <li><a href="{{ url('report/deleteReport/'.$reports->report_id) }}" style="font-weight: bold; color: red;"><i class="fa fa-remove"></i> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
