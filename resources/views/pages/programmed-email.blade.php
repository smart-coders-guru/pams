     ...
     <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Programmed email</h1>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            @foreach($prog_email as $prog_email)  
                                                <tr>
                                                    ...
                                                    <td>{{ $prog_email->programmed_email_is_send_only_to_user }}</td>
                                                    <td class="center">{{ $prog_email->programmed_email_state }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
...
<div class="modal fade" id="emailAccount">
    ...
    <div class="modal fade" id="reportTemplate">
      ...
      <button data-toggle="modal" href="#sendMail" class="btn btnprimary">Send Mail</button>
