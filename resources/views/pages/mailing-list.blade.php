                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach($mailing_list as $mailing)
                                                <tr class="odd gradeX">
                                                    <td>{{ $mailing_list->mailing_list_id }}</td>
                                                    <td><a href="myapps">{{ $mailing_list->mailing_list_name }}</a></td>
                                                    <td>{{ $mailing_list->mailing_list_desc }}</td>
                                                    <td>{{ $mailing_list->mailing_list_additional_email }}</td>
                                                    <td class="center">{{ $mailing_list->mailing_list_state }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
