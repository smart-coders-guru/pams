     ...
     <div id="wrapper">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li> <a href="#" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Programmed email <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            ...
                            <li><a data-toggle="modal" href="#programmedEmail"><i class="fa fa-fw fa-envelope"></i>Programmed an email</a></li>
                        </ul>
                    </li>
                    <li> <a href="#" data-toggle="collapse" data-target="#demo1"><i class="fa fa-fw fa-arrows-v"></i> Mailing list <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo1" class="collapse">
                            ...
                            <li><a data-toggle="modal" href="#mailingList"><i class="fa fa-fw fa-envelope"></i>Add mailing list</a></li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Email Account</h1>
                    </div>
                </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach($email_account as $email_account)  
                                                <tr class="odd gradeX">
                                                    <td>{{ $email_account->email_account_id }}</td>
                                                    <td>{{ $email_account->apps_id }}</td>
                                                    <td>{{ $email_account->email_account_name }}</td>
                                                    <td>{{ $email_account->email_account_email }}</td>
                                                    <td>{{ $email_account->email_account_desc }}</td>
                                                    <td class="center">{{ $email_account->email_account_state }}</td>
                                                </tr>
                                             @endforeach
                                        </tbody>
                                    </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">         
                 ...
                 <div class="card card-login mx-auto mt-5">
                    <div class="card-body">
                       <form method="post" action="{!! url('saveEmailAccount') !!}" accept-charset="UTF-8">
                        {!! csrf_field() !!}
                        <div class="form-group">
                          <div class="form-label-group">
                            <label for="email_account_name">Name</label>
                            <input type="text" id="email_account_name" name="email_account_name" class="form-control" placeholder="Name" required="required" autofocus="autofocus">
                            
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="form-label-group">
                            <label for="email_account_email">Email address</label>
                            <input type="text" id="email_account_email" name="email_account_email" class="form-control" placeholder="Your email ..." required="required">
                            
                          </div>
                        </div>
                        <div class="form-label-group">
                            <label for="email_account_desc">Description</label>
                            <textarea type="text" id="email_account_desc" name="email_account_desc" class="form-control" placeholder="..."></textarea>
                        </div>
                        <div class="form-group" style="margin-top: 20px;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal fade" id="sendMail">
                 ...
                 <div class="modal fade" id="programmedEmail">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">x</button>
                                <h4 class="modal-title">Programmed an email</h4>
                            </div>
                            <div class="modal-body">         
                                 <div class="card card-login mx-auto mt-5">
                                    <div class="card-body">
                                       <form method="post" action="{!! url('saveProgrammedEmail') !!}" accept-charset="UTF-8">
                                        {!! csrf_field() !!}
                                        <div class="form-group">
                                          <div class="form-label-group">
                                            <label for="email_account_name">Name</label>
                ...
                <div class="modal fade" id="mailingList">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">x</button>
